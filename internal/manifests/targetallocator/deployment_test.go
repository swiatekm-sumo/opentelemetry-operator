...
func TestDeploymentSecurityContext(t *testing.T) {
	// Test default
	targetallocator11 := v1alpha2.TargetAllocator{
	...
	targetAllocator2 := v1alpha2.TargetAllocator{
		ObjectMeta: metav1.ObjectMeta{
...
func targetAllocatorInstance() v1alpha2.TargetAllocator {
...
func TestDeploymentNodeSelector(t *testing.T) {
	// Test default
	targetAllocator1 := v1alpha2.TargetAllocator{}
